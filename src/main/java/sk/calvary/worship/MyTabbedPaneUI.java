 ...
 * the Photoshop palette windows. <p/> Copyright (C) 2005 by Jon Lipsky <p/>
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
 * use this file except in compliance with the License. Y ou may obtain a copy
 * of the License at <p/> http://www.apache.org/licenses/LICENSE-2.0 <p/> Unless
 * required by applicable law or agreed to in writing, software d istributed
...
public class MyTabbedPaneUI extends BasicTabbedPaneUI {
    ...
    protected void paintContentBorderTopEdge(Graphics g, int tabPlacement,
        ...
        g
                .drawLine(selectedRect.x + selectedRect.width + 2, y + 1,
                        x + w, y + 1);

        g.setColor(shadow);
        g.drawLine(selectedRect.x + selectedRect.width, y, selectedRect.x
                + selectedRect.width + 1, y + 1);
    }
