...
- 34 JUnit tests, with the display-dependent test skipped in a headless run and executed separately under Xvfb;
- JaCoCo: 7.3% lines, 5.9% branches, and 9.0% methods.
